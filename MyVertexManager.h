#ifndef MyVertexManager_H
#define MyVertexManager_H "$Id:$"

#include "CKBaseManager.h"

#define MyVertexManagerGUID CKGUID(0xfdf864e4, 0x68818ec3)

class MyVertexManager : public CKBaseManager 
{
//##############################################################
//                Public Part                      
//##############################################################
public :
	MyVertexManager(CKContext* Context);
	~MyVertexManager();	
